...
class Album {
    ...
    constructor(symbol, title, cover_xl, label, nb_tracks, fans, release_date,
        record_type, type, genres, contributors, tracklist) {
    ...
    static create(title, cover_xl, label, nb_tracks, fans, release_date,
        record_type, type, genres, contributors, tracklist) {
        return new Album(
