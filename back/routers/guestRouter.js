...
const playlistsController = require("../controllers/entities/playlistsController");
...
router.get("/album/:id", (req, res) => albumsController.getAlbum(req, res));

router.get("/playlist/:id", (req, res) =>
  playlistsController.getPlaylist(req, res)
);
